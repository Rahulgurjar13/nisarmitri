...
const CreateBlogPost = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    author: {
      ...
      avatar: `${BACKEND_URL}/uploads/default-avatar.jpg`,
    },
  });
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Share your sustainable living insights.
          </p>
        </div>
        ...
        >
          <div className="grid gap-6">
            ...
            <div>
              ...
              >
                Excerpt{" "}
                <span className="text-gray-500 text-sm">(1-2 sentences)</span>
              </label>
              <textarea
                id="excerpt"
                name="excerpt"
          ...
          <div className="flex justify-end gap-4 mt-8">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className={`px-6 py-3 bg-[#1A3329] text-white rounded-md hover:bg-[#2F6844] transition-colors flex items-center gap-2 ${
